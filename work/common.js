$('document').ready(function() {
  ...
  $('.calc select, #sliders input[name=slider], #order input[name=order], #animat input[name=anim], #parallax input[name=parall]').change(function() {
    ...
    $parallax = $('#parallax input[name=parall]:checked').val();
    $sect = 300;
    $mod = 300;
    $page = 500;
    $slide = 200;
    ...
    $mnog_par = $par * $parallax;
    $final_price = $mnog_sect + $mnog_mod + $mnog_page + $mnog_slide + $mnog_orde + $mnog_anim + $mnog_par;
