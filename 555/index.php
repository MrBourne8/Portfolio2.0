...
<body>
	...
	<section class="section-3">
		<div class="container">
			...
			<button class="section-3__btn btn-mod">ОСТАВИТЬ ЗАЯВКУ</button>
		</div>
	</section>
	<!-- Название секции End-->
	<!-- Название секции -->
		...
		<div class="container">
			...
			<div class="section-4__wrap">
				<div class="section-4__item">
					<img src="img/icons/04/01.svg" alt="Icon">
					<h3>7 лет на рынке</h3>
					<p>
						Выполнили более 300 проектов. Дорожим репутацией и серьезно относимся к каждому заказу.
					</p>
				</div>
				<div class="section-4__item">
					<img src="img/icons/04/02.svg" alt="Icon">
					<h3>10 монтажных бригад</h3>
					<p>
						Сотрудничаем с крупными заказчиками и строительными компаниями и своевременно выполняем свои обязательства.
					</p>
				</div>
				<div class="section-4__item">
					<img src="img/icons/04/03.svg" alt="Icon">
					<h3>2 года гарантии</h3>
					<p>
						Уверены в качестве наших изделий, но обязуемся устранить любой дефект в течение гарантийного срока.
					</p>
				</div>
				<div class="section-4__item">
					<img src="img/icons/04/04.svg" alt="Icon">
					<h3>Скорость работы</h3>
					<p>
						Заказ запускается в работу буквально на следующий день после согласования деталей. Оговоренные сроки строго соблюдаются.
					</p>
				</div>
				<div class="section-4__item">
					<img src="img/icons/04/05.svg" alt="Icon">
					<h3>Лучшая цена</h3>
					<p>
						Работаем без посредников, сотрудничаем с проверенными поставщиками сырья, предлагаем конкурентную цену на рынке. Найдете дешевле - сделаем скидку 10%.
					</p>
				</div>
				<div class="section-4__item">
					<img src="img/icons/04/06.svg" alt="Icon">
					<h3>Контроль качества</h3>
					<p>
						Контролируем качество на всех этапах реализации проекта. Конструкция сдается заказчику только после проверки мастером и лично директором компании.
					</p>
				</div>
			</div>
		</div>
	...
	<section class="section-6" id="section-6">
		...
		<div class="section-6__wrap">
			<div class="section-6__contact">
				<div class="contact-description">
					<div class="tel">
						<img src="img/icons/06/tel.svg" alt="Tel">
						<p><span>Телефон</span> <br>8 965 131 64 60</p>
					</div>
					<div class="mail">
						<img src="img/icons/06/mail.svg" alt="Mail">
						<p><span>Email</span> <br>info@steelstyling.ru</p>
					</div>
					<div class="adres">
						<img src="img/icons/06/adres.svg" alt="Adres">
						<p><span>Адрес</span> <br>г. Москва, Рабочая улица 84, стр 5</p>
					</div>
					<div class="time">
						<img src="img/icons/06/time.svg" alt="Time">
						<p>
			...
			<div class="section-6__map">
				<iframe src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d2246.1362269282145!2d37.69468031610591!3d55.738762000542074!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x46b54ac9e8a0ed8f%3A0xf2fdbcd435dc7975!2sRabochaya+Ulitsa%2C+84%D1%815%2C+Moskva%2C+Russia%2C+109544!5e0!3m2!1sen!2s!4v1510226980108" width="600" height="450" frameborder="0" style="border:0" allowfullscreen=""></iframe>
			</div>
		</div>
	</section>
	<!-- Название секции End-->
	...
	<div class="modal">
		<form action="mail.php" method="post" class="modal-form">
			<p class="form__title">Оставте свои данные</p>
